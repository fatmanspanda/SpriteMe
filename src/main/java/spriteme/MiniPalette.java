...
public class MiniPalette extends Container {
	...
	private static final int SIZE = SpriteMeGUI.SPLOTCH_SIZE; // used for multi splotches
	...
	private static class MultiSplotch extends JComponent {
		...
		public MultiSplotch(MiniPalette parent, byte i,
			...
			setSize(SpriteMeGUI.SPLOTCH_DIMENSION);
			setMinimumSize(SpriteMeGUI.SPLOTCH_DIMENSION);
			setPreferredSize(SpriteMeGUI.SPLOTCH_DIMENSION);
